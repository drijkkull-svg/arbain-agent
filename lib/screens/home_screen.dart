  ...
  void _listenToDeviceCommands() {
    ...
    _firestore.collection('devices').doc(uid).snapshots().listen((snap) async {
      ...
      setState(() {
        ...
        _isNgajiLocked = data['isNgajiLocked'] ?? false;
      });
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFF00FF88).withValues(alpha: 0.3), width: 2),
                  ),
                  child: const Icon(Icons.mosque, color: Color(0xFF00FF88), size: 64),
                ),
                const SizedBox(height: 32),
                const Text('WAKTU NGAJI', style: TextStyle(color: Color(0xFF00FF88), fontSize: 13, letterSpacing: 4, fontWeight: FontWeight.w600)),
                const SizedBox(height: 8),
                const Text("Al-Mubarok Al-Arba'in", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                const SizedBox(height: 32),
                Container(
                  ...
                  child: const Column(
                    children: [
                      ...
                      SizedBox(height: 12),
                      Text('Anda berada di luar area kajian', style: TextStyle(color: Colors.white70, fontSize: 13), textAlign: TextAlign.center),
                      SizedBox(height: 6),
                      Text('Segera menuju area kajian untuk mengaktifkan HP kembali.', style: TextStyle(color: Colors.white38, fontSize: 11), textAlign: TextAlign.center),
                    ],
                  ),
                ),
                const SizedBox(height: 40),
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  IconButton(icon: const Icon(Icons.phone, color: Color(0xFF00FF88), size: 36), onPressed: () => launchUrl(Uri.parse('tel:'))),
                ]),
              ],
            ),
          ),
